...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        ...
        // 2800, 2200
        public double parYTicks = -2670; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2050; // x position of the perpendicular encoder (in tick units)
    }
