...
public class BlueSampleAuto extends LinearOpMode {
    ...
    Pose2d preloadBucket = new Pose2d(new Vector2d(-60, 59), Math.toRadians(-46.80));
    Pose2d sample1Bucket = new Pose2d(new Vector2d(-60, 59), Math.toRadians(-46.80));
    Pose2d sample2Bucket = new Pose2d(new Vector2d(-60, 59), Math.toRadians(-46.80));
    Pose2d sample3Bucket = new Pose2d(new Vector2d(-57, 62), Math.toRadians(-15.11));
    Pose2d sample4Bucket = new Pose2d(new Vector2d(-57, 62), Math.toRadians(-16));
    Pose2d sample5Bucket = new Pose2d(new Vector2d(-57, 62), Math.toRadians(-16));
    Pose2d sample6Bucket = new Pose2d(new Vector2d(-57, 62), Math.toRadians(-16));
    Pose2d sample7Bucket = new Pose2d(new Vector2d(-57, 62), Math.toRadians(-16));

    Pose2d sample1Pose = new Pose2d(new Vector2d(-57.72, 52), Math.toRadians(-76));
    Pose2d sample2Pose = new Pose2d(new Vector2d(-61.69, 51), Math.toRadians(-91));
    Pose2d sample3Pose = new Pose2d(new Vector2d(-63.84, 49), Math.toRadians(-104));
    Pose2d sample4Pose = new Pose2d(new Vector2d(2.5, 62), Math.toRadians(1.5));
    Pose2d sample5Pose = new Pose2d(new Vector2d(2.5, 62), Math.toRadians(1.5));
    Pose2d sample6Pose = new Pose2d(new Vector2d(2.5, 62), Math.toRadians(1.5));
    Pose2d sample7Pose = new Pose2d(new Vector2d(2.5, 62), Math.toRadians(1.5));
    ...
    Pose2d park = new Pose2d(new Vector2d(4, 63), Math.abs(0));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            scheduler.addAction(new ParallelAction(
                    bucketPreload(),
                    ActionUtil.Delay(0.1 , ActionUtil.Offset(1.4, toBucket, dropFard()))
            ));
...
//                    robot.pauseAuto(telemetry, ()-> gamepad1.touchpad, 1e9),
            ...
            scheduler.addAction(new ParallelAction(
                    transfer(),
                    ActionUtil.Offset(1.8, depositFirst, dropFard())
            ));
...
//                    robot.pauseAuto(telemetry, ()-> gamepad1.touchpad, 1e9),
            ...
            scheduler.addAction(new ParallelAction(
                    transfer(),
                    ActionUtil.Offset(1.8, depositSecond, dropFard())
            ));
...
//                    robot.pauseAuto(telemetry, ()-> gamepad1.touchpad, 1e9),
            ...
            scheduler.addAction(new ParallelAction(
                    transfer(),
                    ActionUtil.Offset(1.8, depositThird, dropFard())
            ));
            scheduler.run();
            ...
            scheduler.addAction(new ParallelAction(
                    transfer(),
                    ActionUtil.Offset(1.8, depositFourth, dropFard())
            ));
            scheduler.run();
            ...
            scheduler.addAction(new ParallelAction(
                    transfer(),
                    ActionUtil.Offset(1.8, depositFifth, dropFard())
            ));
            scheduler.run();
            ...
            scheduler.addAction(new ParallelAction(
                    transfer(),
                    ActionUtil.Offset(1.8, depositSixth, dropFard())
            ));
            scheduler.run();
            ...
            scheduler.addAction(new ParallelAction(
                    transfer(),
                    ActionUtil.Offset(1.8, depositSeventh, dropFard())
            ));
            scheduler.run();
