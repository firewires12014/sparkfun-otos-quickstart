...
@Autonomous(name = "Blue Far Auto (Hail Mary)")
public final class blueFarAutoYeahIdkMan extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action cycle1 = drive.actionBuilder(startPose)
                ...
                .splineToLinearHeading(new Pose2d(new Vector2d(34, -40), Math.toRadians(270)), Math.toRadians(270))
        ...
        Action cycle2 = new ParallelAction(
                drive.actionBuilder(new Pose2d(63, -15, Math.toRadians(270)))
                        .setTangent(Math.toRadians(-90))
                        .splineToLinearHeading(new Pose2d(new Vector2d(63, -60), Math.toRadians(270)), Math.toRadians(270)) // <---  (too hp area)
                        .splineToLinearHeading(new Pose2d(new Vector2d(63, -50), Math.toRadians(270)), Math.toRadians(270)) // (backup) Change these to make it *wiggle* more or less
                        .splineToLinearHeading(new Pose2d(new Vector2d(63, -59), Math.toRadians(270)), Math.toRadians(300)) // (forward to hp area again)
                        .splineToLinearHeading(new Pose2d(new Vector2d(63, -50), Math.toRadians(270)), Math.toRadians(270)) // (backup) Change these to make it *wiggle* more or less
                        .splineToLinearHeading(new Pose2d(new Vector2d(63, -59), Math.toRadians(270)), Math.toRadians(300))
                        // Go back to shoot
